...
<div class="bg-white pd-15 mg-b-20">
    ...
    <div class="form-group mg-b-5">
        ...
        <input name="permission_description" id="permission_description" class="form-control input-lg" placeholder="agregar descripcion" autofocus>
    </div>

    <div class="form-group mg-b-5">
        <label for="permission_order" class="pd-r-5"><span class="hidden-xs pd-r-5"></span><?php print $this->lang->line('permission_order'); ?></label>
        <input name="permission_order" id="permission_order" class="form-control input-lg" placeholder="numero de orden">
