...
<?php $this->load->view('themes/'. Settings_model::$db_config['adminpanel_theme'] .'/partials/content_head.php'); ?>
    ...
    <p class="spacer">
        <button type="submit" name="export_submit" id="export_submit" class="message_cleanup btn btn-primary btn-lg js-btn-loading" data-loading-text="Working...">
            <i class="fa fa-list-ol pd-r-5"></i> Exportar usuarios</button>
    </p>
    ...
    <p class="spacer">
        <button type="submit" name="db_backup_submit" id="db_backup_submit" class="message_cleanup btn btn-primary btn-lg js-btn-loading" data-loading-text="Working...">
            <i class="fa fa-database pd-r-5"></i> Exportar base de datos</button>
    </p>
