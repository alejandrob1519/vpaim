...
<?php $this->load->view('themes/'. Settings_model::$db_config['adminpanel_theme'] .'/partials/content_head.php'); ?>
    ...
    ?>
        ...
        <p>
            <button type="submit" name="sessions_submit" id="sessions_submit" class="btn btn-danger js-btn-loading" data-loading-text="Guardando..."><i class="fa fa-flash pd-r-5"></i> <?php print $this->lang->line('clear_sessions'); ?></button>
        </p>
    ...
    <p>
        <button type="submit" name="site_settings_submit_top" id="settings_form_submit" class="btn btn-primary btn-lg js-btn-loading" data-loading-text="Guardando...">
    ...
    <p>
        <button type="submit" name="site_settings_submit_top" class="btn btn-primary btn-lg js-btn-loading" data-loading-text="Guardando..."><i class="fa fa-check pd-r-5"></i> <?php print $this->lang->line('save_all_settings'); ?></button>
    </p>
