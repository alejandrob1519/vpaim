    ...
    <div class="col-sm-6">
        <div class="form-group">
            ...
            <input type="text" name="role_name" id="role_name" class="form-control input-lg"
                   data-parsley-maxlength="50" placeholder="Ingresar nombre de rol"
                   required autofocus>
        </div>
    </div>
    <div class="col-sm-6">
        <div class="form-group">
            ...
            <textarea name="role_description" id="role_description" class="form-control"
                  data-parsley-maxlength="255" placeholder="Descripcion de rol (max:255 caracteres)"></textarea>
        </div>
    </div>
</div>
            ...
            <div class="col-sm-6">
                <div class="form-group mg-b-0">
                    ...
                    <input type="text" name="role_name" id="role_name_<?php print $role_id; ?>" value="<?php print $role['role_name']; ?>" class="form-control"
                           ...
                           required placeholder="Ingresar nombre de rol">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <textarea name="role_description" id="role_description_<?php print $role_id; ?>" class="form-control"
                              data-parsley-maxlength="255" placeholder="Descripcion de rol (max:255 caracteres)"><?php print $role['role_description']; ?></textarea>
                </div>
            </div>
        </div>
