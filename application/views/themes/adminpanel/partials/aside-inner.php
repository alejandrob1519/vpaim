...
<ul id="demo1" class="menu">
    ...
    <li <?php print ((Site_Controller::$page == "list_members") ? ' class="open"' : "") . ((Site_Controller::$page == "add_member") ? ' class="open"' : ""); ?> >
        <a href="javascript:"><span class="menu-link-icon fa fa-users"></span> <span class="menu-link-title"><?php print $this->lang->line('menu_membership'); ?></span></a>
        <ul>
    ...
    <li <?php print ((Site_Controller::$page == "roles") ? ' class="open"' : "") . ((Site_Controller::$page == "permissions") ? ' class="open"' : ""); ?>>
        <a href="javascript:"><span class="menu-link-icon fa fa-diamond"></span> <span class="menu-link-title"><?php print $this->lang->line('menu_roles_permissions'); ?></span></a>
        <ul>
