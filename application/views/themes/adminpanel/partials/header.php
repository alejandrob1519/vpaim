    ...
    <header class="navbar header" role="menu">
        <div class="navbar-header">
            <a class="navbar-brand block" href="<?php print base_url(); ?>">
                ...
                <div class="navbar-brand-title">
                    RV <span class="navbar-brand-title-small">Atención <small class="f900 text-primary"><em>Integral</em></small></span>
                </div>
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse pd-0">
            ...
            <ul class="nav navbar-nav mg-l-5">
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Actividades <i class="fa fa-list pd-l-5"></i></a>
                    <div class="dropdown-menu dropdown-menu-300">

                        <h4 class="mg-0 pd-10 text-uppercase bg-primary">Mensajes</h4>
